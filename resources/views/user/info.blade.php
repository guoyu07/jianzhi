				...
				<div class="col-md-10">
					...
					<div class="col-md-6">
						@if(Auth::check() and (Auth::user()->id===$user->id))
							<a href="/user/info/{{$user->id}}/edit" class="btn btn-raised btn-danger pull-right">完善个人资料</a>
						@else
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				@foreach($user->works_passed_finished()->sortByDesc('created_at') as $work)
					...
					<div class="row">
						...
						<div class="col-md-4 pull-right">
							<h4>雇主评价</h4>
							<p>{{$work->commentOnUser(Auth::user()->id)->content}}</p>
							<small>{{$work->commentOnUser(Auth::user()->id)->created_at}}</small>
						</div>
					</div>
					<hr>
				@endforeach
