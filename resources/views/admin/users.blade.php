...
<div class="admin-content">
    <div class="admin-content-body">
    	<div class="am-cf am-padding am-padding-bottom-0">
        	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">所有用户</strong><small>All users</small></div>
        </div>
        <hr>
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <td>{{$user->id}}</td>
                <td><a href="/user/info/{{$user->id}}">{{$user->name}}</a></td>
                <td class="am-hide-sm-only">{{$user->gender}}</td>
                <td>{{$user->age}}</td>
